...
if(isset($_GET['n_id']))
  {
	 $b_id = $_GET['n_id'];
	 $qry = "SELECT * FROM blog where b_id = '".$b_id."'";
	...
	$b_publish_date = $row_blog["b_publish_date"];
 	...
 	$_b_url_path = HOST_NAME.'blog/'.$b_url_key.'.html';
...
<div class="content-wrapper">
		...
		<section class="content-header">
			...
			<ol class=" breadcrumb">
				...
				<li class="active"><?php if(isset($_GET['n_id']) && $_GET['n_id'] > 0 ) { echo 'Edit'; }else{ echo 'Add'; } ?> Blog</li>
			  ...
			  <div class="row">
				   <div class="col-xs-12 col-md-12">  
						...
						<div class="">
							   <div class="">
									<?php if($b_id > 0 ) { ?>
									<form role="form" action="<?php echo BASE_ADMIN_URL;?>include/edit_blog_post.php" method="POST" name="blog_add_frm" id="blog_add_frm"  enctype="multipart/form-data">
									<?php }else{ ?>
									
									<form role="form" action="<?php echo BASE_ADMIN_URL;?>include/add_blog_post.php" method="POST" name="blog_add_frm" id="blog_add_frm"  enctype="multipart/form-data">
									<?php } ?>
