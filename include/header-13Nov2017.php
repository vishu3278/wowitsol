...
<link rel="stylesheet" href="<?php echo HOST_NAME; ?>css/semantic.min.css" type="text/css">
<link rel="stylesheet" href="<?php echo HOST_NAME; ?>css/font-awesome.css" type="text/css">
<link rel="stylesheet" href="<?php echo HOST_NAME; ?>css/wow.css" type="text/css">
...
<script src="<?php echo HOST_NAME; ?>plugin/jquery.meanmenu.min.js" type="text/javascript"></script>
  ...
  <div class="top-row">
    <div class="ui container">
      <div class="ui small menu">
        <div class="right menu"> <a href="mailto:info@wowitsolutions.com" class="item"><i class="icon mail outline"></i> info@wowitsolutions.com</a> <a href="tel:+919582408888" class="item"><i class="icon phone"></i> +91 95824 08888</a> 
          <!-- <a href="#" class="item">Technology we are offering</a> --> 
          <!-- <a href="#" class="item">Clients</a>  -->
          <!-- <a href="#" class="item">Blog</a> --> 
          <!-- <a href="#" class="item">Partners</a> --> </div>
      </div>
    </div>
  </div>
  <div class="main-nav">
    <div class="ui container ">
      ...
      <div class="navigation">
        <nav class="row">
          <ul>
            <li><a href="<?php echo HOST_NAME; ?>" class="<?php active('index.php');?>">Home</a></li>
            <li><a href="<?php echo HOST_NAME; ?>about.php" class="<?php active('about.php');?>">About Us</a>
              <ul>
                <li><a href="<?php echo HOST_NAME; ?>work-process.php"  class="<?php active('work-process.php');?>">Work Process</a></li>
               <!-- <li><a href="#">Awards & Achivements</a></li>-->
				<li><a href="<?php echo HOST_NAME; ?>team.php" class="<?php active('team.php');?>">WOW IT Team</a></li>
				<li><a href="<?php echo HOST_NAME; ?>culture.php" class="<?php active('culture.php');?>">WOW Culture</a></li>
								
              </ul>
            </li>
			<li><a class="<?php active('conference-room-booking-management.php');?> <?php active('visitors-tracking-management-system.php');?>">Products</a>
				<ul>
					<li><a href="<?php echo HOST_NAME; ?>HomeSalon"  class="<?php active('conference-room-booking-management.php');?>">Salon Booking System</a></li>
					<li><a href="<?php echo HOST_NAME; ?>conference-room-booking-management.php"  class="<?php active('conference-room-booking-management.php');?>">Conference Room Booking Management</a></li>
					<li><a href="<?php echo HOST_NAME; ?>visitors-tracking-management-system.php" class="<?php active('visitors-tracking-management-system.php');?>">Visitors Tracking Management System</a></li>
				</ul>
            </li>
<!--         <li><a href="services.php" class="<?php //active('services.php');?>">Services</a></li>
 -->          
              <li><a class="<?php active('services.php');?>" href="<?php echo HOST_NAME; ?>services.php">Services</a>
                <ul>
                  <li ><a href="<?php echo HOST_NAME; ?>web-ui-engineering-solutions.php" class="<?php active('web-ui-engineering-solutions.php');?>">Web & UI Engineering Solution</a></li>
                  <li><a href="<?php echo HOST_NAME; ?>web-development-solutions.php" class="<?php active('web-development-solutions.php');?>">Web Development Solutions</a></li>
                  <li><a href="<?php echo HOST_NAME; ?>e-commerce.php" class="<?php active('e-commerce.php');?>">E-Commerce Solutions</a></li>
                  <li><a href="<?php echo HOST_NAME; ?>mobile-apps-development.php" class="<?php active('mobile-apps-development.php');?>">Mobile Apps Development</a></li>
                  <li><a href="<?php echo HOST_NAME; ?>digital-marketing-solutions.php" class="<?php active('digital-marketing-solutions.php');?>">Digital Marketing Solutions</a></li>
                  <li><a href="<?php echo HOST_NAME; ?>content-writing-solutions.php" class="<?php active('content-writing-solutions.php');?>">Content Writing Solutions</a></li>                 

                </ul>
              </li>

              <li><a href="<?php echo HOST_NAME; ?>portfolio.php" class="<?php active('portfolio.php');?>">Portfolio</a></li>
              <li><a href="<?php echo HOST_NAME; ?>news.html" class="<?php active('news.html');?>">News</a></li> 
			   <li><a href="<?php echo HOST_NAME; ?>careers.php" class="<?php active('careers.php');?>">Careers</a></li> 
            <li><a href="<?php echo HOST_NAME; ?>contact.php" class="<?php active('contact.php');?>">Contact Us</a></li>
            <!-- <li><a href="soon.php" class="<?php active('soon.php');?>">Blog</a></li> -->
          </ul>
        </nav>
      </div>
    </div>
