<?php  include('include/header.php');  ?>
  ...
  $query = "SELECT  * FROM   blog  Where b_id > 0 AND b_status = 'publish' ".$search." ORDER BY b_publish_date DESC" ;
  $result = mysqli_query($conn, $query);
  $total_records = mysqli_num_rows($result);

  $query = "SELECT  * FROM   blog  Where b_id > 0 AND b_status = 'publish' ".$search." ORDER BY b_publish_date DESC LIMIT $start, $num_rec_per_page" ;
  $result = mysqli_query($conn, $query);
...
.post-content.media .post-format {
  ...
  <section class="inner-wrapper">
    <div class="ui container ">
      <h2 class="ui black header">Latest Blog</h2>
      <div class="openings">
          ...
          <div class="blog">
            ...
            echo "<a class='item' title='1' href='".$site_url."blog.php?page=1'>".'&laquo;'."</a> "; // Goto 1st page  
            ...
            for ($i=1; $i<=$total_pages; $i++) { 
                ...
                if($page_no == $i ){
                  ...
                  echo "<a class='item ".$class."' title='".$i."' href='".$site_url."blog.php?page=".$i."'>".$i."</a> "; 
              
            }; 
            echo "<a class='item' title='$total_pages' href='".$site_url."blog.php?page=$total_pages'>".'&raquo;'."</a> "; // Goto last page
            ?>
                  </div>
              </div>
            </div>
